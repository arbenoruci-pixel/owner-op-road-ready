...
export const CLOUD_URL = 'https://vnidjrxidvusulinozbn.supabase.co';
// Publishable anon key; private operations require a verified user JWT.
const PUBLIC_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZuaWRqcnhpZHZ1c3VsaW5vemJuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTc1MTk0NjAsImV4cCI6MjA3MzA5NTQ2MH0.hzGSFKU3sKuUKBUBsTE0rKIerj2uhG9pGS8_K9N7tpA';
const ENDPOINT = CLOUD_URL + '/functions/v1/owner-op-cloud-v1';
let client = null, busy = false;
export function cloudClient() {
  if (typeof window === 'undefined') return null;
  if (!client) client = createClient(CLOUD_URL, PUBLIC_KEY, { auth: { storageKey: 'owner-op-cloud-auth-v1', autoRefreshToken: true, persistSession: true, detectSessionInUrl: false } });
  return client;
}
