...
if(!engine.includes('applyCompletePackageV10979')||!engine.includes('parseZip')||!engine.includes('skipExistingSha256')) throw new Error('v109.7.9 cleanup importer missing');
