...
console.log('PASS — officer enters email, Road Ready syncs only the eight-day logs, creates a private capability link, and opens an addressed email without routing-code UI');
