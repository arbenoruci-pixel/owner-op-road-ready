...
patch("source/src/shared/duty/dutyForm.css","0765e6e3cbc26ad04291494d276061d4170a4540b4b213731682cd8b7d27c27a","e1400b74e43f75cc1b799747c3ef1ba2dd9164ed7b34e676147083a38e32b23c",source=>source+"\n/* Live Status formerly positioned Save with translateX(-50%). In the shared\n   footer both actions participate in the same flex layout and keep hit targets. */\nhtml body .dd-root.driver-duty-form.dd-root.dd-root .dd-footer button{transform:none!important;translate:none!important;inset:auto!important;max-width:100%!important}\n"+"\n/* Activity foreground/background must change together, including dark mode. */\nhtml body .dd-root.driver-duty-form.dd-root.dd-root .dd-activity-grid button{transition:none!important}\n");
