...
export function detectDocumentBoundary(image,options={}) {
  ...
  return {...selected,corners,found:true,method:'paper-color-boundaries-v110332',metrics:{...selected.metrics,candidateCount:candidates.length,analysisWidth:frame.w,analysisHeight:frame.h},...(options.debug?{candidates:candidates.slice(0,15)}:{})};
}
