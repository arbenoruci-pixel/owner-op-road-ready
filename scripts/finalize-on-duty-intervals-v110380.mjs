...
const VERSION='110.3.80',BUILD='v110380-continuous-on-duty';
const read=path=>fs.readFileSync(path,'utf8');
import './v110380/install.mjs';
const result=spawnSync(process.execPath,['scripts/v110380/test-on-duty-intervals.mjs'],{stdio:'inherit'});
...
for(const path of ['scripts/test-duty-graph-continuity.mjs','scripts/test-editor-grips-v110355.mjs','scripts/verify-log-integrity-v1051.mjs','scripts/test-document-continuity-integration-v110375.mjs'])fs.writeFileSync(path,read(path).replaceAll("'110.3.79'","'"+VERSION+"'").replaceAll("'v110379-ongoing-on-duty-handoff'","'"+BUILD+"'"));
...
console.log('PASS — 110.3.80 release preserves prior startup, Reader and day-isolation changes');
