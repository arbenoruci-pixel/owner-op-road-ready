...
write('source/src/core/update/appUpdate.js', read('scripts/v10934-update/appUpdateV10934.js.txt'));
write('source/src/modules/update/UpdateBanner.jsx', read('scripts/v10934-update/UpdateBannerV10934.jsx.txt'));
write('source/src/shared/ui/ToolsSheet.jsx', read('scripts/v10934-update/ToolsSheetV10934.jsx.txt'));
write(
  'source/src/app/api/app-version/route.js',
  read('scripts/v10934-update/AppVersionRouteV10934.js.txt').replaceAll('__RELEASED_AT__', RELEASED_AT),
);
write('public/update.html', read('scripts/v10934-update/updateV10934.html.txt'));
write('public/sw.js', read('scripts/v10934-update/swV10934.js.txt'));
