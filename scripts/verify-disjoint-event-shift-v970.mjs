...
assert.ok(result.changedEventIds.includes('b'));
assert.ok(result.changedEventIds.includes('e'));
...
assert.equal(result.events.find(event => event.id === 'b').endMin - result.events.find(event => event.id === 'b').startMin, 60);
assert.equal(result.events.find(event => event.id === 'e').endMin - result.events.find(event => event.id === 'e').startMin, 60);
