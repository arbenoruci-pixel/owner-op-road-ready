...
ok(/^95\.(6[1-9]|[7-9]\d)\.0$/.test(CURRENT_APP_VERSION), 'current update version is v95.61.0 or newer');
...
ok(/^95\.(6[1-9]|[7-9]\d)\.0$/.test(versionJson.version), 'public app-version matches patch or newer');
...
ok(/OWNER_OP_SW_VERSION = '95\.(6[1-9]|[7-9]\d)\.0'/.test(sw), 'service worker version updated');
...
ok(/^95\.(6[1-9]|[7-9]\d)\.0$/.test(pkg.version), 'package version updated');
