...
export function detectDocumentBoundary(image,options={}) {
  ...
  const chosen=refined||best.corners;
  ...
  return {...best,corners,found:true,method:'paper-transition-refinement-v110330',metrics:{...best.metrics,candidateCount:candidates.length,analysisWidth:frame.w,analysisHeight:frame.h},...(options.debug?{candidates:candidates.slice(0,15)}:{})};
}
