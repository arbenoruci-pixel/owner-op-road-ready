...
const VERSION='110.3.81',BUILD='v110381-compact-on-duty';
const read=path=>fs.readFileSync(path,'utf8');
import './v110381/install.mjs';
const result=spawnSync(process.execPath,['scripts/v110381/test-summary.mjs'],{stdio:'inherit'});
...
for(const path of ['scripts/test-duty-graph-continuity.mjs','scripts/test-editor-grips-v110355.mjs','scripts/verify-log-integrity-v1051.mjs','scripts/test-document-continuity-integration-v110375.mjs'])fs.writeFileSync(path,read(path).replaceAll("'110.3.80'","'"+VERSION+"'").replaceAll("'v110380-continuous-on-duty'","'"+BUILD+"'"));
...
console.log('PASS — 110.3.81 release preserves prior startup, Reader and day-isolation changes');
