...
import {normalizePaperV110323} from '../paperQualityV110323.js';
...
export function normalizePaperLighting(image) {return normalizePaperV110323(image);}
function normalizePaperLightingLegacy(image) {
  const {width:w,height:h,data} = image;
